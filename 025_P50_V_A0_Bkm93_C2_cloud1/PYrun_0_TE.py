"""DO NOT DELETE THIS FILE. This script imports the heatsource module and executes the temperature routines.
...
HS_Temperature.py. Kind of a hack implementation but we're still in beta so whateva. ;) """
