"""DO NOT DELETE THIS FILE. This script imports the heatsource module and executes the solar routines.
...
HS_SolarOnly.py. Kind of a hack implementation but we're still in beta so whateva. ;) """
