...
class CSVInterface(object):
    ...
    def SetupInputFiles(self, inputdir, control_file):
        ...
        climatefile = pd.DataFrame(index=timelist, columns=['GlobalRadiation', 'WindSpeed','RelativeHumidity','AirTemp','Cloudiness']*int((IniParams["contsites"]/len(climatefiles))))
        if IniParams["inflowsites"] > 0:
    ...
    def GetContinuousData(self):
        ...
        data = [tuple(zip(line[0:None:5],line[1:None:5],line[2:None:5],line[3:None:5],line[4:None:5])) for line in climatedata.values]
        ...
        for time in timelist:
            ...
            print (line)
            for glorad, wind, humid, air, cloud in line:
                i = c.next()
                #print (i)
                ...
                node.ContData[time] = glorad, wind, humid, air, cloud
