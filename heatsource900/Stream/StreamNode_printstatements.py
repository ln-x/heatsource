...
class StreamNode(object):
    ...
    def CalcDischarge_Opt(self,time):
        print ("running CalcDischarge_Opt")
    ...
    def CalcDischarge_BoundaryNode(self, time):
        print ("running CalcDischarge_BoundaryNode")
        Q_bc = self.Q_bc[time]
        self.Q_mass += Q_bc
...
c_k: %3.4f""" % stderr
    ...
    def CalcHeat_BoundaryNode(self, time, hour, min, sec, JD, JDC, solar_only=False):
        print ("running CalcHeat_BoundaryNode")
        # Reset temperatures
        self.T_prev = self.T
        self.T = None
	...
	print ("running MacCormick_BoundaryNode")
